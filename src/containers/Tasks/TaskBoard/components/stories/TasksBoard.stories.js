import BaseTasksBoard from '@/containers/Tasks/TaskBoard/components/TasksBoard'

export default {
  title: 'TasksBoard',
  component: BaseTasksBoard
}
...
const Template = () => {
  return <BaseTasksBoard items={[sampleTask]} />
}

export const TasksBoard = () => <Template />
