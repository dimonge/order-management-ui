    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <a exact to="/" className="block">
            <Image
              src="/modeliver_logo.png"
              alt="modeliver logo"
              height={40}
              width={50}
            />
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarItem pathname={pathname} routes={sidebarRoutes} />
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer ${
                  pathname.includes('dashboard') && 'bg-gray-900'
                }`}
              >
                <Link
                  exact
                ...
                >
                  <div className="flex items-center">
                    <svg className="flex-shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      ...
                      <path
                        className={`fill-current text-gray-400 ${
                          pathname.includes('dashboard') && 'text-indigo-200'
                        }`}
